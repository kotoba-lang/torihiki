...
- runtimes: JVM `clojure -M -e '(load-file "evidence/falsify9-accum-paths.cljc") (load-file "evidence/falsify9-jvm-driver.clj")'` → falsify9-jvm.{out,err} (exit=0); nbb `nbb --classpath "$(nbb script/nbb-classpath.cljs)" evidence/falsify9-driver.cljs` → falsify9-nbb.{out,err} (exit=0)
