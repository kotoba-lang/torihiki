...
- in-flight (not perturbed, background): falsify-11 JVM honest-walk PID 2897 (started 21:25 prev day, 673 CPU-min, k=500000 @ 08:38, coll3 pinned at 2^53−1) **and a second falsify-11 JVM walk PID 54913** (started 07:30 today, `evidence/falsify11-fees-accum.cljk` + `evidence/falsify11-jvm-driver.cljk`, 39 CPU-min @ 08:38). Completed output belongs to a later iteration's review.
